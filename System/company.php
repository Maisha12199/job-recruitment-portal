...
<head>
	...
	<title>Chakri - <?php echo "$compname"; ?></title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="CHAKRI">
							<a href="./"><img src="images/port.png" alt="CHAKRI" /></a>
						</div>
					</div>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Chakri is a job portal, online job management system developed by Maisha in 2021.</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Vision Software</p>
