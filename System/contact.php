...
<head>
	...
	<link rel="shortcut icon" href="images/ico/port.png">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/port.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Mohakhali, <br/> Dhaka, <br/>School Junction</address>
								</li>
								<li>
										<h5>Email</h5><a href="maisha.ibnat@g.bracu.ac.bd">maisha.ibnat@g.bracu.ac.bd</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+880 015 345 789">+880 015 345 789</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Chakri</h5>
											<p>Chakri is a job portal, online job management system developed by Maisha  in august 2022.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Chakri Contact</h5>
								
								<p>Address : Mohakhali,Dhaka</p>
								<p>Email : <a href="Maisha@gmail.com">maisha@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Maisha12199 Software</p>
