...
<head>
	...
	<title> apple - <?php echo "$jobtitle"; ?></title>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About  apple</h5>
											<p>apple is a job portal, online job management system developed by appy in february 2018.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">apple Contact</h5>
								
								<p>Address : uttara,dhaka</p>
								<p>Email : <a href="appy@programmer.net">appy@programmer.net</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> appySoft</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by appy160</a></li>
								</ul>
